...
local Window = OrionLib:MakeWindow({Name = "YT isnahamzah | Ganteng Hub (S)epuh ", HidePremium = false, SaveConfig = true, ConfigFolder = "Ganteng Sepuh", IntroIcon = "http://www.roblox.com/asset/?id=15006559003"})
