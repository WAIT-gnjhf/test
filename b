...
MiscTab:AddToggle({
    ...
    ImageButton.Position = UDim2.new(0.102301791, 0, 0.20769231, 0)
    ImageButton.Size = UDim2.new(0, 82, 0, 77)
    ImageButton.Image = "http://www.roblox.com/asset/?id=15006559003"
    ImageButton.MouseButton1Down:Connect(function()
        game:GetService("VirtualInputManager"):SendKeyEventt(true,"RightShift",false,game)
        game:GetService("VirtualInputManager"):SendKeyEventt(false,"RightShift",true,game)
    end)
