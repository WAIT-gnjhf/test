...
local Window = OrionLib:MakeWindow({Name = "YT isnahamzah | Ganteng Hub (S)epuh ", HidePremium = false, SaveConfig = true, ConfigFolder = "HyperVersion"})
...
spawn(function()
    while wait() do
        if FarmSkip then
            LvCount = game.Players.LocalPlayer.Data.Level.Value
            if LvCount >= 1 and LvCount < 60 then
                local cframefarm = CFrame.new(-7894.6176757813, 5547.1416015625, -380.29119873047)
                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - cframefarm.Position).Magnitude > 1500 then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
                end
                if game.Workspace.Enemies:FindFirstChild("Shanda") then     
                    for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == "Shanda" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                            repeat task.wait()
                                ...
                                PosMonShanda = v.HumanoidRootPart.CFrame                                                                       
                                ...
                                game:GetService'VirtualUser':CaptureController()
                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))                                            
                            until not FarmSkip or not v:FindFirstChild("HumanoidRootPart") or v.Humanoid.Health <= 0 or not v.Parent
                            StartBring = false
                            _G.NOCLIP = false
                        end 
                    end
...
MainTab:AddToggle({
    ...
    spawn(function()
        while wait() do
            if _G.QUESTCB then
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    if _G.AutoDoughtBoss or _G.Autodoughking then
                        ...
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameMag.Position).Magnitude <= 2200 then
                            local args = {
                                [1] = "StartQuest",
                                [2] = "CakeQuest1",
                                [3] = 1
                    ...
                    elseif _G.Auto_Bone then
                        local CFrameMagB = CFrame.new(-9516.99316, 172.017181, 6078.46533, 0, 0, -1, 0, 1, 0, 1, 0, 0) 
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameMagB.Position).Magnitude <= 2200 then
                            local args = {
                                [1] = "StartQuest",
                                [2] = "HauntedQuest2",
                                [3] = 1
            ...
            pcall(function()
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.FarmAllSwordMas and StartMagnetBoneMon600 then
                        ...
                        if FarmSkip and StartBring then
                            if (v.Name == "Shanda") and (v.HumanoidRootPart.Position - PosMonShanda.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CFrame = PosMonShanda
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
...
MiscTab:AddToggle({
    ...
    MiscTab:AddDropdown({
        Name = "Select Mode Farm All Sword 600 Mas",
        Default = "...",
        Options = {"Cake Prince",},
        Callback = function(Value)
            _G.SelectMode = Value
    ...
    MiscTab:AddToggle({
        Name = "Farm All Sword Mas 600",
        Default = false,
        Callback = function(Value)
            _G.FarmAllSwordMas = Value
            _G.NOCLIP = Value
            StopTween(_G.FarmAllSwordMas)
        end    
    })
                            ...
                            if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.FarmAllSwordMas or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                                        ...
                                        if v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" then
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                repeat wait()
                                                    ...
                                                    v.Head.CanCollide = false 
                                                    v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                                    MagnetDought600 = true
                                                    PosMonDoughtOpenDoor = v.HumanoidRootPart.CFrame
                                                    topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                                    game:GetService("VirtualUser"):CaptureController()
                                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                until not _G.FarmAllSwordMas or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or KillMob == 0
                                            end
                                        end
                                    end
                                else
                                    MagnetDought600 = false
                                    topos(CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375))
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter [Lv. 2200]") then
                                        topos(game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter [Lv. 2200]").HumanoidRootPart.CFrame * CFrame.new(2,20,2)) 
                                    else
                ...
                if type(v) == "table" then
                    if v.Type == "Sword" then
                        if tonumber(v.Mastery) >= 1 and tonumber(v.Mastery) < 600 then
                            ...
                            Mastery = v.Mastery
                            if tonumber(v.Mastery) >= 1 and tonumber(v.Mastery) < 600 then
                                if _G.SelectMode == "Cake Prince" then
                                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" then
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
